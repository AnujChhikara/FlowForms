...
export default function LoginPage() {
  ...
  return (
    <>
      <div className='container relative hidden bg-black text-white dark min-h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0'>
        <Link
          to='/register'
          className={cn(
