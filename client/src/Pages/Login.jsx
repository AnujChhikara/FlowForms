...
export function LoginPage() {
  ...
  return (
    <div className='flex flex-col md:flex md:flex-row min-h-screen w-screen dark bg-background'>
      <div className='md:w-1/2 flex items-start space-x-2 justify-start md:p-12 p-8'>
        <div className='flex items-center justify-center space-x-2'>
          ...
          <h1 className='font-bold text-4xl font-sans text-white'>FlowForm</h1>
        </div>
      </div>
      <div className='flex items-center justify-center md:w-1/2  min-h-screen'>
        <Card className='md:w-full max-w-md w-[90%]'>
