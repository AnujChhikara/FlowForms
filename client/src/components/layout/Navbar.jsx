      ...
      <div className="sm:p-3 p-2  mx-auto h-full flex items-center justify-between gap-2">
            ...
            <div className="sm:flex ">
              <Link to="/" className="flex items-center">
                <div className="relative z-20 flex items-center text-lg font-medium">
                  ...
                  <p className="text-xl font-bold"> FormFlow</p>
                </div>
              </Link>
            </div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center space-x-2">
            <Link
              to="/register"
              className="inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium  rounded-lg group bg-gradient-to-br from-zinc-400 to-zinc-900   text-white"
            >
              <span className=" px-2 py-1 transition-all ease-in duration-300 bg-black rounded-md ">
                Register
              </span>
            </Link>
         ...
         rounded-lg border border-zinc-800 contrast-125
          bg-[linear-gradient(110deg,#18181b,45%,#555651,55%,#18181b)] bg-[length:200%_100%]
           px-4 py-1 font-medium text-zinc-200 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
            >
              Login
            </Link>
          </div>
